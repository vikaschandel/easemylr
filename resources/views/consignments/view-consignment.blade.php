                        ...
                        <div class="panel panel-white full_height" >
                            <div class="panel-heading">
                                ...
                                <!-- <?php //if (check_permissions('cn', 'add')){ ?>  -->
                                    ...
                                    <a href="{{'create'}}"><button class="btn btn-success btn-addon m-b-sm">+ Add
                                            New</button></a>
                            ...
                            <div class="panel-body"  style="overflow:scroll">
                                <div >
                                    <table id="consignment_table" class="table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        ?>
                                            <tr id="{{ $consignment->id }}"
                                                class="cons_list <?php if ($i == 0) {?> selected <?php }?>">
                                                <td>
                                                    <div>
                                                        <div class="col-ms-<?php if ($consignment->total_freight == 0) {echo "
                                                            12";} else {echo "9" ;}?>" style="margin-bottom:10px">
                    ...
                    <div class="col-sm-8">
                        <div class="panel panel-white">
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h1 style="font-size:22px;" class="m-b-md"><b>Eternity Forwarders Private
                                                Limited.</b></h1>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <table class="custom_table" width="100%">
                                                        ...
                                                        <tr>
                                                            <td><span id="consignerAddress">Melbourne, Australia<br>P: (123)
                                                                    456-7890</span></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                <div class="col-sm-4">
                                                    <table class="custom_table" width="100%">
                                                        ...
                                                        <tr>
                                                            <td><span id="consigneeAddress">Melbourne, Australia<br>P: (123)
                                                                    456-7890</span></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                    <div class="col-sm-4">
                                                        <table class="custom_table" width="100%">
                                                            ...
                                                            <tr>
                                                                <td><span id="ship_to_Address">Melbourne, Australia<br>P: (123)
                                                                        456-7890</span></td>
                                                            </tr>
                                                        </table>
                                            `       </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div style="overflow-x:auto;">
                                            <table id="items_table" class="">
                                                <thead>
                                                    <tr class="line_items">
                                                        <th width="5%"
                                                            style="border:solid 1px #A9A9A9;border-style:solid; font-family:Open Sans,sans-serif; padding:5px;">
                                                            Sr. No.</th>
                                                        <th width="15%"
                                                            style="border:solid 1px #A9A9A9;border-style:solid; padding:3px; font-family:Open Sans,sans-serif; padding:5px;">
                                                            Description</th>
                                                        <th width="14%"
                                                            style="border:solid 1px #A9A9A9;border-style:solid; padding:3px; font-family:Open Sans,sans-serif; padding:5px;">
                                                            Quantity</th>
                                                ...
                                                <tfoot>
                                                    <tr class="total_items">
                                                        ...
                                                        <td
                                                            style="border:solid 1px #A9A9A9;border-style:solid; padding:3px; font-family:Open Sans,sans-serif; padding:5px;">
                                                            <strong><span id="qty" class="no-m"></span></strong></td>
                                                        <td
                                                            style="border:solid 1px #A9A9A9;border-style:solid; padding:3px; font-family:Open Sans,sans-serif; padding:5px;">
                                                            <strong><span id="net_weight" class="no-m"></span>
                                                                Kgs.</strong></td>
                                                        <td
                                                            style="border:solid 1px #A9A9A9;border-style:solid; padding:3px; font-family:Open Sans,sans-serif; padding:5px;">
                                                            <strong><span id="gross_weight" class="no-m"></span>
                                                                Kgs.</strong></td>
                                                        <td
                                                            style="border:solid 1px #A9A9A9;border-style:solid; padding:3px; font-family:Open Sans,sans-serif; padding:5px;">
                                                            <strong><span id="currency">INR </span><span
                                                                    id="tot_amt"></span></strong></td>
                                                        <td
                                                            style="border:solid 1px #A9A9A9;border-style:solid; padding:3px; font-family:Open Sans,sans-serif; padding:5px;">
                                                        </td>
                                                    </tr>
                                    ...
                                    <div class="row">                
                                        ...
                                        <div class="col-md-4">                          
                                            <div class="text-right">
                                                <button class="btn btn-default" type="button"><a id="printcon"
                                                        data-printtoid="1" href="{{url($prefix.'/consignments/')}}"><i
                                                            class="fa fa-print"></i>Print</a></button>
                                                <button class="btn btn-default" type="button"><a id="printshipcon"
                                                        data-printtoid="2" href="{{url($prefix.'/consignments/')}}"><i
                                                            class="fa fa-print"></i>Print (with Ship To)</a></button>
                                            </div>
                                        </div>
                                    </div>
                                    <!--row-->
